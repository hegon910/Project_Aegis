...
{
    private static PlaythroughHistory _instance;
    public static PlaythroughHistory Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = FindObjectOfType<PlaythroughHistory>();
                if (_instance == null)
                {
                    GameObject obj = new GameObject("PlaythroughHistory");
                    _instance = obj.AddComponent<PlaythroughHistory>();
                }
            }
            return _instance;
        }
